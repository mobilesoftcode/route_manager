...
class CustomTransitionDelegate extends TransitionDelegate {
  final bool showTransitionAnimation;
  const CustomTransitionDelegate({this.showTransitionAnimation = true})
      : super();
  ...
  Iterable<RouteTransitionRecord> resolve(
    ...
    bool showAnimation = (showTransitionAnimation && !kIsWeb)
        ? locationToExitingPageRoute.isEmpty ||
